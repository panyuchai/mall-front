<template>
	<view>
			...
			<!-- <view class="yt-list-cell border-bottom" v-if="payData.balance">
				...
				<view class="cell-tip cell-account-tip">
					...
					<view class="action-right">
						<switch class="switchBtn" style="transform:scale(0.7)" color="#E93548"/>
					</view>
				</view>
			</view> -->
		...
		<view class="footer">
			...
			<view class="submit" @click="handleSubmit">微信支付</view>
		</view>
				  ...
				  function(res){
					if(res.err_msg == "get_brand_wcpay_request:ok" ){
					  ...
					  // uni.removeStorageSync('chooseAddress');
					    window.location.href='//'+that.baseUrl + '#/pages/orderDetail/orderDetail?orderId='+that.initData.orderId+"&mallDomain="+this.mallDomain;
					}else{
						// uni.removeStorageSync('chooseAddress');
						window.location.href='//'+that.baseUrl + '#/pages/order/order?state=0'+"&mallDomain="+this.mallDomain;
					}
				  }
				)
			},
