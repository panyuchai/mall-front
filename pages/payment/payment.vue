			...
			handleWxWebPay(data){
				...
				.then( res => {
					if(res.result && res.result.orderState == 1){
						...
						window.location.href=`http://${this.paymentUrl}.yujianli.cn/#/pages/payment/cashRegister?orderNo=`+res.result.orderNo+"&mallDomain=yyy"+"&paymentrder="+JSON.stringify(data)
						// uni.navigateTo({
